  ...
  return (
    <div className='space-y-5 animate-in fade-in duration-500'>
      <div className='flex justify-between items-start'>
        ...
        <button className='flex items-center gap-2 px-4 py-1.5 bg-purple-50 text-purple-700 rounded-lg hover:bg-purple-100 transition-all text-sm font-semibold border border-purple-100 shadow-sm group'>
          <Sparkles size={16} className='group-hover:scale-110 transition-transform text-purple-600' />
